...
```
DEEPGRAM_API_KEY=b324c31f73cd25ff5bf796f4d8d880ccdf9d820e
GOOGLE_AI_API_KEY=AQ.Ab8RN6K4ES0AEeAbR8Kc3QOw-a95RwD4l6cL7PQhHfb8WpxsGw
...
echo -n "b324c31f73cd25ff5bf796f4d8d880ccdf9d820e" | \
  gcloud secrets versions add flowstudio-deepgram-api-key --data-file=- --project=$PROJECT

echo -n "AQ.Ab8RN6K4ES0AEeAbR8Kc3QOw-a95RwD4l6cL7PQhHfb8WpxsGw" | \
