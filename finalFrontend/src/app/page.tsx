  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-background">
      ...
      >
        ...
        >
          Record your product. FlowStudio analyzes intent signals, cuts dead time, schedules zooms, and hands you a polished timeline &mdash; before you touch the editor.
        </motion.p>
      ...
      <footer className="relative z-10 border-t border-border px-8 py-10 lg:px-16">
        <div className="mx-auto max-w-6xl flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="flex items-center gap-4">
            <FluxLogo size="sm" />
            <span className="text-xs text-muted-foreground">&copy; 2026 FlowStudio &middot; GenAI Genesis Hackathon</span>
          </div>
